...
SongBook.create(user_id: 1)
SongBook.create(user_id: 2)
SongBook.create(user_id: 3)
SongBook.create(user_id: 4)
...
Song.create(title: "Heartbreaker", style_id: 4, song_book_id: 1)
Song.create(title: "Change In Me", style_id: 8, song_book_id: 1)
Song.create(title: "Heartbreaker", style_id: 4, song_book_id: 3)
Song.create(title: "Heartbreaker", style_id: 4, song_book_id: 4)
Song.create(title: "I Have Confidence", style_id: 1, song_book_id: 1)
Song.create(title: "Bohemian Rhapsody", style_id: 4, song_book_id: 2)
